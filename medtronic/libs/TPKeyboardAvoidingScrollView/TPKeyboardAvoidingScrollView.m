...
- (void)keyboardWillHide:(NSNotification*)notification {
    ...
    //self.contentOffset = self.contentInset-;
    [self setScrollIndicatorInsets:self.contentInset];
    _priorInsetSaved = NO;
    [UIView commitAnimations];
}
...
-(void)adjustOffsetToIdealIfNeeded {
    ...
    CGFloat visibleSpace = self.bounds.size.height - self.contentInset.top - self.contentInset.bottom - DEFAULT_TOOLBAR_HEIGHT;
